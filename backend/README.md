...
## Project Structure
    ...
    ├── peter_mobile_detail_40743  # Django project configurations
...
1. Clone this repo and `cd peter_mobile_detail_40743`
...
2. Clone this repo and `cd peter_mobile_detail_40743`
